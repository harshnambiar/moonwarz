...
const stats = (/* unused pure expression or super */ null && (['Attack', 'Defence', 'Speed', 'Accuracy', 'Mana', 'HP']));
...
const monsters = ['Abyss', 'Banshit', 'Coquo', 'Dumdum', 'Sharqueen', 'Cyberflare', 'Mermina', 'Wormhell', 'Seraphix', 'Cosyz', 'Tungstongue', 'Aria', 'Satun', 'Storja', 'Gaia', 'Despire', 'Feris', 'Vanquash', 'Momori', 'Jarinn', 'Qwala', 'Ristora', 'Saibill', 'Veilara', 'Thram', 'Zenshi', 'Extone', 'Cereph', 'Firaoh', 'Lucy', 'Lavia', 'Zias', 'Dawn', 'Dusk', 'Frosta', 'Robomoo', 'Toten', 'Moody', 'Raiha', 'Goomoo', 'Motu', 'Radia', 'Bowen', 'Sarta', 'Mizuku', 'Weng', 'Cosma', 'Bullstein', 'Severa', 'Jalice'];
...
const monsterStats = [
    ...
    ['Sharqueen', 1, 3, 90, 49, 93, 86, 66, 79, 'Water Tackle', 'Hydro Veil', 'Frost Fangs', 'Tsunami Surge', 'img/sharqueen.png'],
    ['Cyberflare', 0, 0, 110, 98, 70, 85, 64, 97, 'Flame Punch', 'Flame Up', 'Burning Uppercut', 'Infernal Storm', 'img/cyberflare.png'],
    ['Mermina', 1, 1, 80, 100, 80, 91, 62, 80, 'Water Tackle', 'Rising Tide', 'Steam Blast', 'Tsunami Surge', 'img/mermina.png'],
    ['Wormhell', 7, 5, 20, 140, 93, 90, 100, 79, 'Dark Slash', 'Rile Up', 'Eternal Cannon', 'Dark Phantasm', 'img/wormhell.png'],
    ['Seraphix', 6, 4, 45, 120, 101, 85, 107, 77, 'Light Burst', 'Clear Soul', 'Aura Blind', 'Infinite Radiance', 'img/seraphix.png'],
    ['Cosyz', 4, 5, 90, 40, 109, 73, 90, 51, 'Gravity Beam', 'Cosmo Guard', 'Galactic Storm', 'Antimatter Havoc', 'img/cosyz.png'],
    ['Tungstongue', 5, 0, 70, 120, 60, 87, 80, 120, 'Metal Slash', 'Sharpen Blade', 'Metal Debris', 'Magnetic Annihilation', 'img/tungstongue.png'],
    ['Aria', 1, 4, 67, 101, 98, 92, 93, 90, 'Water Pulse', 'Steaming Ice', 'Cyclone Slash', 'Tsunami Surge', 'img/aria.png'],
    ['Satun', 0, 2, 100, 60, 65, 88, 100, 76, 'Flame Punch', 'Flame Up', 'Searing Burn', 'Infernal Storm', 'img/satun.png'],
    ['Storja', 2, 3, 130, 65, 111, 65, 80, 75, 'Storm Strike', 'Charge Up', 'Paralyzing Wave', 'Lightning Pulse', 'img/storja.png'],
    ['Gaia', 3, 4, 84, 90, 68, 98, 94, 90, 'Rockfall', 'Nature Sync', 'Calm of Green', 'Tectonic Blast', 'img/gaia.png'],
    ['Despire', 4, 2, 70, 70, 113, 89, 123, 105, 'Gravity Beam', 'Destabilizing Wave', 'Galactic Storm', 'Antimatter Havoc', 'img/despire.png'],
    ['Feris', 6, 3, 91, 65, 70, 70, 130, 71, 'Light Burst', 'Clear Soul', 'Malevolent Slumber', 'Infinite Radiance', 'img/feris.png'],
    ['Vanquash', 1, 2, 80, 84, 80, 88, 78, 104, 'Water Punch', 'Flowing Grace', 'Steam Blast', 'Tsunami Surge', 'img/vanquash.png'],
    ['Momori', 5, 3, 77, 80, 103, 85, 99, 84, 'Metal Beam', 'Steel Guard', 'Mirror Maze', 'Magnetic Annihilation', 'img/momori.png'],
    ['Jarinn', 7, 1, 90, 62, 129, 96, 80, 78, 'Dark Punch', 'Shadow Dance', 'Nightmare Slash', 'Dark Phantasm', 'img/jarinn.png'],
    ['Qwala', 3, 0, 107, 88, 55, 84, 99, 82, 'Stone Throw', 'Dust Guard', 'Sapping Ground', 'Tectonic Blast', 'img/qwala.png'],
    ['Ristora', 6, 3, 90, 49, 93, 89, 117, 79, 'Light Burst', 'Illumination', 'Blinding Light', 'Infinite Radiance', 'img/ristora.png'],
    ['Saibill', 5, 0, 110, 78, 70, 75, 110, 97, 'Iron Punch', 'Upgrade', 'Paralyzing Wave', 'Magnetic Annihilation', 'img/saibill.png'],
    ['Veilara', 1, 2, 62, 60, 80, 95, 162, 80, 'Water Tackle', 'Hydraulic Charge', 'Steam Blast', 'Tsunami Surge', 'img/veilara.png'],
    ['Thram', 7, 2, 60, 90, 96, 90, 141, 86, 'Dark Slash', 'Rile Up', 'Uncertain Fate', 'Dark Phantasm', 'img/thram.png'],
    ['Zenshi', 6, 2, 93, 75, 104, 89, 92, 77, 'Light Burst', 'Clear Soul', 'Final Purge', 'Infinite Radiance', 'img/zenshi.png'],
    ['Extone', 3, 5, 134, 111, 109, 93, 36, 81, 'Rockfall', 'Grounded Focus', 'Heated Land', 'Tectonic Blast', 'img/extone.png'],
    ['Cereph', 4, 5, 72, 120, 60, 88, 100, 123, 'Spacial Wave', 'Temporal Warp', 'Galactic Storm', 'Antimatter Havoc', 'img/cereph.png'],
    ['Firaoh', 0, 1, 73, 111, 98, 92, 89, 90, 'Fire Burst', 'Flame Up', 'Burning Toxins', 'Infernal Storm', 'img/firaoh.png'],
    ['Lucy', 7, 2, 100, 60, 62, 68, 140, 76, 'Shadow Beam', 'Unholy Focus', 'Nightmare Slash', 'Dark Phantasm', 'img/lucy.png'],
    ['Lavia', 0, 5, 83, 107, 78, 99, 88, 84, 'Fire Burst', 'Rile Up', 'Final Purge', 'Infernal Storm', 'img/lavia.png'],
    ['Zias', 2, 1, 75, 100, 91, 88, 110, 93, 'Lightning Fist', 'Thunderous Roar', 'Ionic Prison', 'Lightning Pulse', 'img/zias.png'],
    ['Dawn', 6, 4, 100, 70, 91, 90, 110, 105, 'Holy Burst', 'Clear Soul', 'Sacred Flames', 'Infinite Radiance', 'img/dawn.png'],
    ['Dusk', 7, 4, 110, 65, 90, 90, 110, 100, 'Unholy Burst', 'Clear Soul', 'Unholy Venom', 'Dark Phantasm', 'img/dusk.png'],
    ['Frosta', 1, 3, 90, 100, 75, 93, 60, 100, 'Water Tackle', 'Clear Soul', 'Frost Fangs', 'Tsunami Surge', 'img/frosta.png'],
    ['Robomoo', 5, 0, 81, 108, 85, 99, 50, 83, 'Metal Beam', 'Upgrade', 'Metal Debris', 'Magnetic Annihilation', 'img/robomoo.png'],
    ['Toten', 3, 2, 97, 83, 71, 91, 81, 90, 'Stone Throw', 'Nature Sync', 'Sapping Ground', 'Tectonic Blast', 'img/toten.png'],
    ['Moody', 1, 4, 80, 93, 91, 76, 90, 83, 'Water Punch', 'Steaming Ice', 'Steam Blast', 'Tsunami Surge', 'img/moody.png'],
    ['Raiha', 2, 2, 97, 79, 70, 88, 83, 80, 'Storm Strike', 'Illumination', 'Ionic Prison', 'Lightning Pulse', 'img/raiha.png'],
    ['Goomoo', 3, 2, 60, 121, 77, 93, 71, 110, 'Rockfall', 'Rile Up', 'Quake', 'Tectonic Blast', 'img/goomoo.png'],
    ['Motu', 3, 4, 101, 125, 60, 91, 20, 150, 'Stone Throw', 'Clear Soul', 'Heated Land', 'Tectonic Blast', 'img/motu.png'],
    ['Radia', 6, 5, 92, 79, 99, 92, 85, 89, 'Light Burst', 'Clear Soul', 'Paralyzing Wave', 'Infinite Radiance', 'img/radia.png'],
    ['Bowen', 7, 5, 79, 98, 107, 95, 108, 81, 'Dark Slash', 'Unholy Focus', 'Final Purge', 'Dark Phantasm', 'img/bowen.png'],
    ['Sarta', 0, 3, 88, 90, 76, 97, 93, 94, 'Fire Burst', 'Flame Up', 'Sacred Flames', 'Infernal Storm', 'img/sarta.png'],
    ['Mizuku', 1, 0, 72, 111, 87, 89, 98, 107, 'Water Punch', 'Hydraulic Charge', 'Cyclone Slash', 'Tsunami Surge', 'img/mizuku.png'],
    ['Weng', 2, 3, 81, 100, 83, 88, 111, 93, 'Lightning Fist', 'Thunderous Roar', 'Paralyzing Wave', 'Lightning Pulse', 'img/weng.png'],
    ['Cosma', 4, 4, 101, 71, 88, 90, 110, 99, 'Holy Burst', 'Temporal Warp', 'Galactic Storm', 'Antimatter Havoc', 'img/cosma.png'],
    ['Bullstein', 4, 0, 52, 89, 109, 99, 123, 91, 'Spacial Wave', 'Cosmo Guard', 'Ionic Prison', 'Antimatter Havoc', 'img/bullstein.png'],
    ['Severa', 6, 5, 105, 67, 92, 90, 110, 102, 'Unholy Burst', 'Clear Soul', 'Uncertain Fate', 'Infinite Radiance', 'img/severa.png'],
    ['Jalice', 5, 1, 101, 70, 91, 90, 115, 99, 'Iron Punch', 'Steel Guard', 'Metal Debris', 'Magnetic Annihilation', 'img/jalice.png']


]

const monsterSprites = Array(50).fill().map(() => new Image());
k = 0;
...
const movesData = [
    ...
    ['Tectonic Blast', 0, 100, 0, 100, 0, 100, 0, 100, 0, 100, 'The ultimate Earth type attack. Does great damage. Costs 2 spirit.'],
    ...
    ['Antimatter Havoc', 0, 100, 0, 100, 0, 100, 0, 100, 0, 100, 'The ultimate Cosmic type attack. Does great damage. Costs 2 spirit.'],
...
const statuses = (/* unused pure expression or super */ null && (['None', 'Burned', 'Poisoned', 'Frostbitten', 'Stunned', 'Drowsy', 'Dazed']));
...
class Team {
  ...
  generateTeam(existingMonsters = []) {
    const availableIndices = Array.from({ length: 50 }, (_, i) => i) // Indices 0–32
        ...
        if (gameState == 'initial'){
            ...
            if (whoAttacks == 0){
                ...
                if (pm_spd_now >= am_spd_now){
                    ...
                    //here
                    if (playerMove == 1 && !res1.includes('missed') && !res1.includes('move')){
                        await new Promise(resolve => setTimeout(resolve, 1000));
...
async function animateFirstMove(ctx, startX, startY, endX, endY, typeColor, pm, am, terrainNow, attacker, moveName, duration = 500) {
    const steps = 15;
...
async function animateBeam(ctx, startX, startY, endX, endY, typeColor, pm, am, attacker, terrainNow, duration = 1000) {
    const steps = 30;
    const stepDuration = duration / steps;
    const deltaX = (endX - startX) / steps;
    const deltaY = (endY - startY) / steps;
    const beamColor = '#FFFFFF'; // White beam for contrast
    const glowColor = typeColor; // Type-colored glow
    ...
    for (let i = 0; i <= steps; i++) {
        ...
        ctx.font = '24px Arial';
        ctx.fillText(
            attacker === 'player' ? `Your ${pm.name} used ${pm.move4}` : `Foe ${am.name} used ${am.move4}`,
            textBoxX + 70,
            textBoxY + 60
        );
        ...
        ctx.lineTo(startX + deltaX * i, startY + deltaY * i);
